...
"""
def make_lexicon(i_libri_lex, i_cmu, o_lex):
...
raw_librispeech_path = "/fhgfs/bootphon/data/raw_data/LibriSpeech/train-clean-100"
...
dict_librispeech_path = "/fhgfs/bootphon/data/raw_data/LibriSpeech/"

# flac is required for converting .flac to .wav.
flac = "/usr/bin/flac"

# Path to a directory where the processed corpora is to be stored
output_dir = "/fhgfs/bootphon/scratch/xcao/abkhazia/corpora/LibriSpeech_train-clean-100/"
