...
"""
Data preparation WSJ for journalist spontaneous speech
"""
...
#output_dir = "/fhgfs/bootphon/scratch/thomas/abkhazia/corpora/WSJ_journalist_spontaneous"
#output_dir = "/Users/thomas/Documents/PhD/Recherche/other_gits/abkhazia/corpora/WSJ_journalist_spontaneous"
output_dir = "/home/github_abkhazia/abkhazia/corpora/WSJ_journalist_spontaneous"
...
"""
STEP 0 - Listing relevant files for journalist_spontaneous part using the following 3 criterions:
...
"""
bad_utts = find_corrupted_utts(journalist_spontaneous_dot)
...
"""
wv1_2_wav(journalist_spontaneous_wv1, wav_dir, sph2pipe, exclude=bad_utts)
...
make_transcript(journalist_spontaneous_dot, output_file, exclude=bad_utts)
