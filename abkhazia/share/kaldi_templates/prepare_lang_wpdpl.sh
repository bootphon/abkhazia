...
if $position_dependent_phones; then
  ...
  # dependent version of each 'phone' word as pronunciation variants (pretty ad hoc),
  # it does not change <unk> word beyond adding _S to its transcription (also ad hoc).
