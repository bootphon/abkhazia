...
class KCSSPreparator(AbstractPreparator):
    ...
    def __init__(self, input_dir, trs_level='pronunciation',
        ...
        self.log.info('preparing corpus at %s level', trs_level)
    ...
    def _load_textgrid(self, trs_level):
        """Returns the TextGrid files in a dict utt_id: textgrid data"""
    ...
    def _make_transcription_single(self, record):
        """Build the transcription for a single TextGrid"""
