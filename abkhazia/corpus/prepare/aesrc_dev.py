...
preparator = AESRCPreparator(
   ...
   #dataset_path :'/scratch1/data/raw_data/AESRC/Datatang-English/data/American English Speech Data'
    copy_wavs=False,log=log)

# prepare the aesrc corpus into abkhazia format (using a temp directory to
